using CourseApi.Api.Entidades;
using CourseApi.Api.Services;
...
namespace CourseApi.Api.DbContexts
{
    public class CourseLibraryContext:DbContext
    {
        ...
        public static implicit operator CourseLibraryContext(CourseLibraryRepository v)
        {
